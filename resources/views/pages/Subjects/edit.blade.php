                    ...
                    <div class="col-xs-12">
                        <div class="col-md-12">
                            ...
                            <form action="{{route('subjects.update','test')}}" method="post" autocomplete="off">
                                ...
                                <div class="form-row">
                                    <div class="col">
                                        <label for="title">{{trans('subject.subjects_name_ar')}}</label>
                                    ...
                                    <div class="col">
                                        <label for="title">{{trans('subject.subjects_name_en')}}</label>
                                ...
                                <div class="form-row">
                                    <div class="form-group col">
                                        <label for="inputState">{{trans('grades.title_page1')}}</label>
                                    ...
                                    <div class="form-group col">
                                        <label for="inputState">{{trans('My_Classes_trans.title_page1')}}</label>
