...
@section('css')
    @toastr_css
@section('title')
    {{trans('Students_trans.add_feeI')}}
@stop
@endsection
@section('page-header')
    <!-- breadcrumb -->
@section('PageTitle')
    {{trans('Students_trans.add_feeI')}}  {{$student->name}}
@stop
<!-- breadcrumb -->
@endsection
@section('content')
                                    ...
                                    <div data-repeater-list="List_Fees">
                                        <div data-repeater-item>
                                            <div class="row">
                                                ...
                                                <div class="col">
                                                    <label for="Name_en" class="mr-sm-2">{{__('Students_trans.fees_type')}}</label>
                                                    <div class="box">
                                                ...
                                                <div class="col">
                                                    <label for="Name_en" class="mr-sm-2">{{__('Students_trans.amount')}}</label>
                                                    <div class="box">
                                                ...
                                                <div class="col">
                                                    <label for="description" class="mr-sm-2"> {{trans('Students_trans.byan')}}</label>
                                                    <div class="box">
