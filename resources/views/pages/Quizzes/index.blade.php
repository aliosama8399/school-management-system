                        ...
                        <div class="card card-statistics h-100">
                            <div class="card-body">
                                <a href="{{route('Quizzes.create')}}" class="btn btn-success btn-sm" role="button"
                                   aria-pressed="true">{{__('quiz.quiz_add')}}</a><br><br>
                                                        ...
                                                        <div class="modal-content">
                                                            <div class="modal-header">
                                                                <h5 style="font-family: 'Cairo', sans-serif;"
                                                                    class="modal-title" id="exampleModalLabel">{{__('quiz.quiz_del')}}</h5>
                                                            ...
                                                            <div class="modal-body">
                                                                <p> {{ trans('My_Classes_trans.Warning_class') }} {{$quizze->name}}</p>
