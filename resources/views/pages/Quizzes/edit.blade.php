                        ...
                        <div class="col-md-12">
                            ...
                            <form action="{{route('Quizzes.update','test')}}" method="post">
                                ...
                                <div class="form-row">
                                    ...
                                    <div class="col">
                                        <label for="title">{{__('quiz.quiz_name_ar')}}</label>
                                    ...
                                    <div class="col">
                                        <label for="title">{{__('quiz.quiz_name_en')}}</label>
                                ...
                                <div class="form-row">
                                    ...
                                    <div class="col">
                                        <div class="form-group">
                                            <label for="Grade_id">{{__('subject.subject')}} : <span class="text-danger">*</span></label>
