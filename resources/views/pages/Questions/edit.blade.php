...
@section('page-header')
    <!-- breadcrumb -->
@section('PageTitle')
    {{__('question.question_edit')}} :<span class="text-danger">{{$question->title}}</span>
@stop
<!-- breadcrumb -->
@endsection
@section('content')
                        ...
                        <div class="col-md-12">
                            ...
                            <form action="{{ route('questions.update','test') }}" method="post" autocomplete="off">
                                ...
                                <div class="form-row">
                                    ...
                                    <div class="col">
                                        <label for="title">{{__('question.question_term')}}</label>
                                ...
                                <div class="form-row">
                                    <div class="col">
                                        <label for="title">{{__('question.question_name_ar')}}</label>
                                ...
                                <div class="form-row">
                                    <div class="col">
                                        <label for="title">{{__('question.question_name_en')}}</label>
                                ...
                                <div class="form-row">
                                    <div class="col-6">
                                        <div class="form-group">
                                            <label for="Grade_id">{{__('question.question_name')}} : <span
                                    ...
                                    <div class="col-6">
                                        <div class="form-group">
                                            <label for="Grade_id">{{__('question.question_degree')}} : <span class="text-danger">*</span></label>
                                ...
                                <br>
                                <button class="btn btn-success btn-sm nextBtn btn-lg pull-right" type="submit">{{__('Students_trans.submit')}}</button>
                            </form>
                        </div>
                    </div>
                </div>
