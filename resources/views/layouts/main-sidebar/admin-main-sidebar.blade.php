    ...
    <ul class="nav navbar-nav side-menu" id="sidebarnav">
        ...
        <li>
            ...
            <ul id="classes-menu" class="collapse" data-parent="#sidebarnav">
                <li><a href="{{route('Classrooms.index')}}">{{trans('sidebar.List_classes')}}</a></li>
            </ul>
        </li>
        ...
        <li>
            ...
            <ul id="Teachers-menu" class="collapse" data-parent="#sidebarnav">
                <li> <a href="{{route('Teachers.index')}}">{{trans('sidebar.List_Teachers')}}</a> </li>
            </ul>
        </li>
        ...
        <li>
            ...
            <ul id="Parents-menu" class="collapse" data-parent="#sidebarnav">
                <li> <a href="{{url('add_parent')}}">{{trans('sidebar.List_Parents')}}</a> </li>
            </ul>
        </li>
        ...
        <!-- Settings-->
        <li>
            <a href="{{route('settings.index')}}"><i class="fas fa-cogs"></i><span class="right-nav-text">{{trans('sidebar.Settings')}} </span></a>
        </li>
